document.addEventListener('DOMContentLoaded', () => {
    ...
    if (productId) {
        ...
        docRef.get().then((doc) => {
            ...
            const mainContent = document.querySelector('main');
            mainContent.innerHTML = '<p class="not-found">Error loading product details. Please try again later.</p>';
        });
    } else {
        const mainContent = document.querySelector('main');
        mainContent.innerHTML = '<p class="not-found">No product ID provided.</p>';
    }
});
